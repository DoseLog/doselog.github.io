<p align="center">
  <img src="icon.svg" width="88" alt="DoseLog icon">
</p>

<h1 align="center">DoseLog</h1>
...
<p align="center">
  <strong><a href="https://doselog.github.io">doselog.github.io</a></strong>
</p>
...
DoseLog helps you keep track of **what you've taken, how much, and — most importantly — how long ago**. Each substance gets a card with a running "time since last dose" front and center.
...
<p align="center">
  <img src="screenshot.png" width="340" alt="DoseLog showing two substance cards with time since last dose, and tonight's dose log">
</p>
...
DoseLog is a PWA (progressive web app) — visit once, keep it forever:

- **iPhone / iPad:** open [doselog.github.io](https://doselog.github.io) in Safari → Share → **Add to Home Screen**
...
Questions, feedback, or ideas? Write to **doselogsupport@proton.me** — no name needed.

## Disclaimer

DoseLog is a logging tool, not medical advice. It doesn't judge, warn, or recommend doses; it just helps you remember. If you or someone near you feels seriously unwell, contact emergency services. Honest information about what was taken helps medics act fast.
